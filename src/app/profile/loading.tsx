    ...
    <div className="min-h-screen bg-[var(--color-background)]">
      ...
      <main className="mx-auto max-w-[680px] px-4 py-8">
        <div className="animate-pulse">
          <div className="h-16 w-16 bg-white/8 rounded-full mb-4" />
          <div className="h-6 bg-white/8 rounded mb-2 w-1/3" />
          <div className="h-4 bg-white/5 rounded mb-6 w-1/2" />
          {[1, 2, 3].map((i) => (
            <div
              key={i}
              className="rounded-xl border border-white/5 bg-[var(--color-surface)] p-5 mb-4"
            >
